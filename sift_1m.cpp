...
void sift_test1M() {
    ...
    char *path_gt = "sift/sift_groundtruth.ivecs";
    char *path_q = "sift/sift_query.fvecs";
    char *path_data = "sift/sift_base.fvecs";
    sprintf(path_index, "sift1m_%dm_ef_%d_M_%d.bin", subset_size_milllions, efConstruction, M);

    //sprintf(path_gt, "sift/sift_groundtruth.ivecs");
    ...
    unsigned char *massQ = new unsigned char[qsize * vecdim *sizeof(float)];
